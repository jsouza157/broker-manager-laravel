            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                      <form method="POST" action="{{ route('login_authenticate') }}" autocomplete="off">
                        {{ csrf_field() }}
                            <div class="card card-login card-hidden">
                                ...
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-info btn-wd">Entrar</button>
                                    <a href="{{ route('recovery_view') }}" class="btn btn-info btn-simple btn-wd">Esqueceu sua senha ?</a>
                                    <a href="{{ route('user_create') }}" class="btn btn-info btn-simple btn-wd">Crie uma conta</a>
                                </div>
                            </div>
                        </form>
                    </div>
